...
public class AssistanceAgentClaimListUndergoingService extends AbstractGuiService<AssistanceAgent, Claim> {
	...
	@Autowired
	public AssistanceAgentClaimListUndergoingService(final AssistanceAgentClaimRepository repository) {
	...
	public void unbind(final Claim object) {
		...
		dataset = super.unbindObject(object, "registrationMoment", "type", "indicator");
